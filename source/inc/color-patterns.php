 ...
 */
function reborn_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Reborn default saturation level.
	 *
	 * @since Reborn 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'reborn_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.reborn-front-page) .entry-title,
...
.colors-custom .reborn-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.reborn-front-page .panel-content .recent-posts article,
...
.colors-custom.reborn-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Reborn custom colors CSS.
	 *
	 * @since Reborn 1.0
	 *
	 ...
	 */
	return apply_filters( 'reborn_custom_colors_css', $css, $hue, $saturation );
}
